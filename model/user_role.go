...
type UserRole struct {
	...
	CreatedAt string `gorm:"autoCreateTime" json:"created_at"`      // CreatedAt 记录了用户获得角色的时间
	UpdatedAt string `gorm:"autoUpdateTime" json:"updated_at"`      // UpdatedAt 记录了用户角色信息最后更新的时间
}
